...
typedef enum
{
	...
	OCL_KERNEL_IWT_FLUX,
	OCL_KERNEL_IWT_PRECOMPUTE,
	OCL_KERNEL_IWT_Q,
	OCL_KERNEL_IWT_UPDATE_INFO,
	OCL_KERNEL_IWT_FLUCTUATIONS,
	OCL_KERNEL_IWT_APPLY_FLUCTUATIONS,
	OCL_KERNEL_IWT_MASS_CHARGE,
	OCL_KERNEL_IWT_REDSHIFT_DAMPING,
	OCL_KERNEL_IWT_WAVE_COUNT_POINTS,
	OCL_KERNEL_IWT_WAVE_EMIT,
    OCL_KERNEL_COUNT
} ocl_kernel_t;
