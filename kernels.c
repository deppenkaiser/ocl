...
protected const char* ocl_get_source_iwt_update_info(void)
{
    ...
    "    // ============================================================\n"
    "    double Z_i = 0.0;\n"
    "    if (abs_old > 1e-30 && fabs(flow) > 1e-30)\n"
    "    {\n"
    "        Z_i = abs_old / fabs(flow);\n"
    "    }\n"
    "\n"
    "    // ============================================================\n"
    "    // 3. Globaler Mittelwert der Wellenwiderstände (Z_avg)\n"
    "    // ============================================================\n"
    "    // Wird als Parameter übergeben (in run_update_info berechnet)\n"
    "\n"
    "    // ============================================================\n"
    "    // 4. Dynamischer Reflexionskoeffizient\n"
    "    //    Gamma_i = (Z_i - Z_avg) / (Z_i + Z_avg)\n"
    "    // ============================================================\n"
    "    double Gamma_i = 0.0;\n"
    "    // Wird in run_update_info übergeben\n"
    "\n"
    "    // ============================================================\n"
    "    // 5. Erhaltende Reflexion\n"
    "    //    I_i_neu = I_i - DT*sumJ_i + Gamma_i * (I_avg - I_i)\n"
    "    // ============================================================\n"
    "    // Wird in run_update_info übergeben\n"
    "\n"
    "    // ============================================================\n"
    "    // 6. Phasen-Update (unverändert)\n"
    "    // ============================================================\n"
    "    double phase_new = I_phase[i] + DT * Q[i];\n"
    "\n"
    "    // ============================================================\n"
    "    // 7. Begrenzung (nur untere Grenze)\n"
    "    // ============================================================\n"
    "    if (abs_new < 0.0) abs_new = 0.0;\n"
    "\n"
    "    // ============================================================\n"
    "    // 8. Phasen-Faltung (unverändert)\n"
    "    // ============================================================\n"
