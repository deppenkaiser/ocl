...
protected const char* ocl_get_source_iwt_update_info(void)
{
    ...
    "\n"
    "    // ============================================\n"
    "    // KORREKTE UPDATE-REGEL:\n"
    "    // Amplitude wird durch den Fluss verändert\n"
    "    // Phase wird durch Q verändert\n"
    "    // ============================================\n"
    "\n"
    "    // 1. Amplitude durch Fluss verändern (informationserhaltend)\n"
    "    double flow = sumJ[i];\n"
    "    double abs_new = I_abs[i] + DT * flow;\n"
    "\n"
    "    // Begrenzung auf [0, 1]\n"
    "    if (abs_new < 0.0) abs_new = 0.0;\n"
    "    if (abs_new > 1.0) abs_new = 1.0;\n"
    "\n"
    "    // 2. Phase durch Q verändern (Führung, kein Energietransport)\n"
    "    double phase_new = I_phase[i] + DT * Q[i];\n"
    "\n"
    "    // 3. Randbedingung: Phase verschieben, Amplitude bleibt erhalten\n"
    "    if (is_boundary)\n"
    "    {\n"
