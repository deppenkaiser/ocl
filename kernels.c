...
protected const char* ocl_get_source_iwt_update_info(void)
{
    ...
    "    double real_prev = I_abs_prev[i] * cos(I_phase_prev[i]);\n"
    "    double imag_prev = I_abs_prev[i] * sin(I_phase_prev[i]);\n"
    "\n"
    "    double sumJ_real = sumJ[i * 2 + 0];\n"
    "    double sumJ_imag = sumJ[i * 2 + 1];\n"
    "\n"
    "    double real_new = 2.0 * real_i - real_prev + DT * DT * sumJ_real;\n"
    "    double imag_new = 2.0 * imag_i - imag_prev + DT * DT * sumJ_imag;\n"
    "\n"
