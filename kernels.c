...
protected const char* ocl_get_source_iwt_update(void)
{
    return
    "// ============================================================\n"
    "// IWT-Kernel - NUR lokale Nachbarn (KEINE Schleife über alle Knoten)\n"
    "// ============================================================\n"
    "\n"
    ...
    "\n"
    "    // ============================================================\n"
    "    // 1. Lokale Weber-Kräfte (NUR die 12 Nachbarn)\n"
    "    // ============================================================\n"
    ...
    "\n"
    "    // ============================================================\n"
    "    // 2. Globales Bohm-Potential (bereits auf Host berechnet)\n"
    "    // ============================================================\n"
...
protected const char* ocl_get_source_iwt_update_motion(void)
{
    return
    "// ============================================================\n"
    "// IWT-Kernel mit beweglichen Knoten (Information + Position)\n"
    "// ============================================================\n"
    "\n"
    "__kernel void iwt_update_motion(\n"
    "    __global double* nodes,\n"
    "    __global double* x,\n"
    "    __global double* y,\n"
    "    __global double* z,\n"
    ...
    "\n"
    "    // ============================================================\n"
    "    // 1. Kräfte berechnen (aus IWT) + Masse (IWT)\n"
    "    // ============================================================\n"
    ...
    "        double F_total = F_wed + F_wg + F_q;\n"
    "\n"
    "        // Kraftkomponenten (Einheitsvektor)\n"
    "        double inv_dist = 1.0 / dist;\n"
    "        Fx += F_total * dx * inv_dist;\n"
    "        Fy += F_total * dy * inv_dist;\n"
    "        Fz += F_total * dz * inv_dist;\n"
    "\n"
    "        // Masse (IWT) – siehe Kapitel 3.3.3\n"
    "        mass_sum += diff * diff;\n"
    "\n"
    "        // Informations-Update (wie gehabt)\n"
    "        if (F_total > 1e3) F_total = 1e3;\n"
    "        if (F_total < -1e3) F_total = -1e3;\n"
    "        I_new += F_total * dt;\n"
    "    }\n"
    "\n"
    "    // ============================================================\n"
    "    // 2. Masse aus IWT (δ ist dimensionslos)\n"
    "    // ============================================================\n"
    "    double delta = 1.0; // Kopplungskonstante\n"
    "    double mass = delta * mass_sum;\n"
    "    if (mass < 1e-30) mass = 1e-30;\n"
    "\n"
    "    // ============================================================\n"
    "    // 3. Bohm-Potential (Q) – wie gehabt\n"
    "    // ============================================================\n"
    "    I_new += q_potential[i] * dt;\n"
    "\n"
    "    // ============================================================\n"
    "    // 4. Bewegung der Knoten (Newton: F = m * a)\n"
    "    // ============================================================\n"
    "    double ax = Fx / mass;\n"
    "    double ay = Fy / mass;\n"
    "    double az = Fz / mass;\n"
