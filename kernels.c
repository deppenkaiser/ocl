...
protected const char* ocl_get_source_iwt_update_motion(void)
{
    return
    "// ============================================================\n"
    "// IWT-Kernel mit GLOBALER Wechselwirkung (WDBT+)\n"
    "// ============================================================\n"
    "\n"
    ...
    "        double diff = I_i - I_j;\n"
    "\n"
    "        // Abstandsgewichtung (fraktale Dämpfung)\n"
    ...
    "        double F_wg  = -diff / pow(r, D - 2.0);\n"
    "        double F_q   = diff / pow(r, D - 2.0);\n"
    "        double F_ij = (F_wed + F_wg + F_q) * weight;\n"
    "\n"
    ...
    "    }\n"
    "\n"
    "    double mass = mass_sum;\n"
    "    if (mass < 1e-30) mass = 1e-30;\n"
    "\n"
    "    double total_force = F_total + q_potential[i];\n"
    "\n"
    "    double I_new = I_i + total_force * dt;\n"
    "    if (I_new < 1e-12) I_new = 1e-12;\n"
    "\n"
    "    double ax = Fx / mass;\n"
    "    double ay = Fy / mass;\n"
    "    double az = Fz / mass;\n"
