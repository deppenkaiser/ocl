...
// ============================================================
// kernels.c - IWT-Kernel mit Stubs für WG, WED, Q
// ============================================================
...
protected const char* ocl_get_source_iwt_update(void)
{
    return
    "// ============================================================\n"
    "// IWT-Kernel – Grundstruktur mit Stubs für WG, WED, Q\n"
    "// ============================================================\n"
    "\n"
    "// Stub-Funktionen (werden später ausgefüllt)\n"
    "float iwt_wg_force(float I_i, float I_j, float r, float D, float l0) {\n"
    "    return 0.0f;\n"
    "}\n"
    "\n"
    "float iwt_wed_force(float I_i, float I_j, float r, float D, float l0) {\n"
    "    return 0.0f;\n"
    "}\n"
    "\n"
    "float iwt_q_force(float I_i, float I_j, float r, float D, float l0) {\n"
    "    return 0.0f;\n"
    "}\n"
    "\n"
    "// Hauptkernel: addiert die drei Anteile\n"
    ...
    "        dist = pow(dist, D - 2.0f) * l0;\n"
    "\n"
    "        // Drei Kräfte addieren\n"
    "        float F_wg  = iwt_wg_force(I_i, I_j, dist, D, l0);\n"
    "        float F_wed = iwt_wed_force(I_i, I_j, dist, D, l0);\n"
    "        float F_q   = iwt_q_force(I_i, I_j, dist, D, l0);\n"
    "\n"
    "        float F_total = F_wg + F_wed + F_q;\n"
    "\n"
    "        I_new += F_total * dt;\n"
    "    }\n"
    "\n"
    "    // Wertebegrenzung\n"
    "    if (I_new > 1.0e6f) I_new = 1.0e6f;\n"
    "    if (I_new < 1.0e-12f) I_new = 1.0e-12f;\n"
    "\n"
    "    nodes[i] = I_new;\n"
    "}\n";
}
