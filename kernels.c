...
protected const char* ocl_get_source_iwt_flux(void)
{
    ...
    "\n"
    "    double I_i = I_abs[idx];\n"
    "    double sum = 0.0;\n"
    "    double R_sum = 0.0;\n"
    "    double T_sum = 0.0;\n"
    "\n"
    "    double Z_i = Z_0 * (1.0 + alpha * I_i);\n"
    "\n"
    "    for (int j = 0; j < N; j++)\n"
    "    {\n"
    "        if (j == idx) continue;\n"
    ...
    "    }\n"
    "\n"
    "    double max_out = I_i / DT;\n"
    "    double max_in = (I_max - I_i) / DT;\n"
...
protected const char* ocl_get_source_iwt_update_info(void)
{
    ...
    "\n"
    "    // ============================================================\n"
    "    // KORRIGIERTES UPDATE: ∂I/∂t = - (1/(2I)) · ∇·J\n"
    "    // ============================================================\n"
    "    double abs_new;\n"
    "    if (abs_old > 1e-30) {\n"
    "        abs_new = abs_old - DT * flow / (2.0 * abs_old);\n"
    "    } else {\n"
    "        // Wenn I sehr klein ist, kann der Fluss nur als Quelle wirken\n"
    "        abs_new = abs_old + DT * fabs(flow);\n"
    "    }\n"
    "\n"
    "    // Phase: Q wirkt auf die Phase\n"
    "    double phase_new = I_phase[i] + DT * Q[i];\n"
    "\n"
    "    // Fluktuationen (Anhang O & P)\n"
