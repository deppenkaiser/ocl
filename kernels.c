...
protected const char* ocl_get_source_iwt_update_info(void)
{
    ...
    "    if (i >= N) return;\n"
    "\n"
    "    // Entropie-Term: -gamma * ln(I / I0)\n"
    "    double entropy = GAMMA_ENTROPY * log(I[i] / I0);\n"
    "\n"
    "    // Euler-Lagrange mit Entropie-Term\n"
    "    double I_new = 2.0 * I[i] - I_prev[i] + DT * DT * sumJ[i] - DT * DT * entropy;\n"
    "    I[i] = I_new;\n"
    "}\n";
}
...
protected const char* ocl_get_source_iwt_update_coupling(void)
{
    ...
    "\n"
    "        // Vollständige K-Dynamik\n"
    "        double K_new = Kij + DT * (\n"
    "            ETA * (diff * diff)                    // lokaler Korrelationsterm\n"
    "            - LAMBDA * laplace_I / I_mid           // Krümmungsterm\n"
    "            - MU * Q_diff                          // Bohm-Term\n"
    "            + GAMMA * Kij * log(1.0 + rho * L * L) // fraktaler Term\n"
    "        );\n"
    "\n"
    "        K[idx * N + j] = K_new;\n"
    "        K[j * N + idx] = K_new;\n"
