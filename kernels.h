...
protected_import(const char*, ocl_get_source_compute_flux(void));
protected_import(const char*, ocl_get_source_compute_q(void));
protected_import(const char*, ocl_get_source_update_I(void));
protected_import(const char*, ocl_get_source_update_K(void));