...
protected_import(const char*, ocl_get_source_iwt_update(void));
protected_import(const char*, ocl_get_source_q_field(void));
protected_import(const char*, ocl_get_source_iwt_update_motion(void));
